...
LLM-Based Quiz Generation Assignment
...
Database: PostgreSQL (SQLite used for local testing)
...
A full-stack AI-powered Wiki Quiz Generator where users can:

Provide a Wikipedia article URL

Automatically generate quizzes using a Large Language Model
...
The system transforms Wikipedia articles into structured quizzes, showcasing real-world LLM integration with backend systems.
...
AI-powered quiz generation via LangChain + Gemini
...
Practical real-world use of LLMs
